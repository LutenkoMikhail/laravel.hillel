                    ...
                    <div class="card-body">
                        <form method="post" action="{{url('account/'. $user->id)}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="birthday" type="date" class="form-control @error('birthday') is-invalid @enderror" name="birthday" value="{{date_create( $user->birthday)->Format('Y-m-d')}}" required autocomplete="birthday" autofocus>
